...
public interface IOAuthManagerLocal {
    ...
    OAuthProvider createProvider(String name, boolean enabled,
                                 String issuer, String clientID, String jwsAlgorithm,
                                 String jwkSetURL, String redirectUri, String secret) throws AccountNotFoundException;

    OAuthProvider updateProvider(int id, String name, boolean enabled,
                                 String issuer, String clientID, String jwsAlgorithm,
                                 String jwkSetURL, String redirectUri, String secret) throws AccountNotFoundException, OAuthProviderNotFoundException;
